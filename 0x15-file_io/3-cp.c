...
/**
 * create_buffer - Allocates 1024 bytes for a single buffer
 * @file: Name of the file buffer it's storing chars for
 *
...
/**
 * main - Copies contents of a file to another one
 * @argc: Number of arguments outlied in the program
